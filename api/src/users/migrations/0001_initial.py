# Generated by Django 4.2.23 on 2025-08-30 10:49

import core.validators.lowercase_validator
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(blank=True, error_messages={'unique': 'A user with that username already exists.'}, help_text='Required. 30 characters or fewer. Letters, numbers, and @/./+/-/_ only.', max_length=30, unique=True, validators=[core.validators.lowercase_validator.LowercaseValidator()], verbose_name='user name')),
                ('email', models.EmailField(blank=True, max_length=254, unique=True, verbose_name='email address')),
                ('first_name', models.CharField(max_length=150)),
                ('last_name', models.CharField(max_length=150)),
                ('is_member', models.BooleanField(default=False, verbose_name='member status')),
                ('photo', models.ImageField(blank=True, null=True, upload_to=users.models.user.get_profile_image_filepath, verbose_name='photo')),
